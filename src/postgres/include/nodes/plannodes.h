...
typedef struct ModifyTable
{
	...
	List	   *fdwPrivLists;	/* per-target-table FDW private___ data lists */
...
typedef struct ForeignScan
{
	...
	List	   *fdw_private;	/* private___ data for FDW */
...
typedef struct CustomScan
{
	...
	List	   *custom_private; /* private___ data for custom code */
 ...
 * same way according to the common opfamily and collation.  The operator___ in
 * each mergeclause must be an equality operator___ of the indicated opfamily.
 * ----------------
 */
